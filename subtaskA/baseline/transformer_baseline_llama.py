...
import evaluate
import numpy as np
from transformers import LlamaForCausalLM, AutoModelForSequenceClassification, TrainingArguments, Trainer, DataCollatorWithPadding, AutoTokenizer, set_seed
import os
...
def fine_tune(train_df, valid_df, checkpoints_path, id2label, label2id, model):
    ...
    print("Collated data, trying to train")
    # create Trainer 
